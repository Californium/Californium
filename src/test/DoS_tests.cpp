...
BOOST_AUTO_TEST_CASE(DoS_checknbits)
{
    ...
    BlockData chainData =
        // Bitcoin blocks, but still applies.
        map_list_of(1239852051,486604799)(1262749024,486594666)
        (1279305360,469854461)(1280200847,469830746)(1281678674,469809688)
        (1296207707,453179945)(1302624061,453036989)
        (1309640330,437004818)  // BTC #134444
        (1313172719,436789733); // BTC #140700
    ...
    BOOST_CHECK(!CheckNBits(firstcheck.second, lastcheck.first+90 /* nTargetTimespan: 90 seconds */, lastcheck.second, lastcheck.first));
    BOOST_CHECK(!CheckNBits(firstcheck.second, lastcheck.first+60*3 /* nTargetSpacing: 3 minutes */, lastcheck.second, lastcheck.first));

    // ... but OK if enough time passed for difficulty to adjust downward:
    BOOST_CHECK(CheckNBits(firstcheck.second, lastcheck.first+60*60*24*365*4 /* 4 years */, lastcheck.second, lastcheck.first));
}
