...
make -f makefile.linux-mingw $MAKEOPTS DEPSDIR=$STAGING Californiumd.exe USE_UPNP=0 DEBUGFLAGS="-frandom-seed=Californium" USE_SSE2=1
$HOST-strip *.exe
rm -rf $OUTDIR/daemon
mkdir $OUTDIR/daemon
